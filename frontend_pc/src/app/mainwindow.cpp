...
void MainWindow::volume_rendering(bool status)
{
	if (status == false)
	{
        ...
        //colorFun->AddRGBPoint(f(0.0), 59.0 / 255.0, 76.0 / 255.0, 192.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.25), 141.0 / 255.0, 176.0 / 255.0, 254.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.375), 184.0 / 255.0, 208.0 / 255.0, 249.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.4375), 204.0 / 255.0, 217.0 / 255.0, 238.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.46875), 213.0 / 255.0, 219.0 / 255.0, 230.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.5), 221.0 / 255.0, 221.0 / 255.0, 221.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.53125), 229.0 / 255.0, 216.0 / 255.0, 209.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.5625), 236.0 / 255.0, 211.0 / 255.0, 197.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.625), 245.0 / 255.0, 196.0 / 255.0, 173.0 / 255.0);
        //colorFun->AddRGBPoint(f(0.75), 244.0 / 255.0, 154.0 / 255.0, 123.0 / 255.0);
        //colorFun->AddRGBPoint(f(1.0), 180.0 / 255.0, 4.0 / 255.0, 38.0 / 255.0);
